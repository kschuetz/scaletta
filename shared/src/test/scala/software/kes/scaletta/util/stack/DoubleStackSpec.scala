...
class DoubleStackSpec extends AnyFunSpec with Matchers {
  describe("DoubleStack") {
    ...
    it("should support expand and contract") {
      ...
      stack.unsafeWrite(0, 49.9)
      stack.unsafeWrite(1, 47.7)
      stack.unsafeWrite(2, 45.5)

      stack.peek() shouldBe Some(49.9)
      stack.pop() shouldBe 49.9
      stack.pop() shouldBe 47.7
      stack.pop() shouldBe 45.5
