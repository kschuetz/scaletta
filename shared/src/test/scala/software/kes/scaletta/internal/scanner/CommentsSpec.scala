...
import software.kes.scaletta.internal.scanner.CommentResult.{BlockComment, LineComment, NoComment, Unterminated}
...
class CommentsSpec extends AnyFunSpec with Matchers {
  describe("comments") {
