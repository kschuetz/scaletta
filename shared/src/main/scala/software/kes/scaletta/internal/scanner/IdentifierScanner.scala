...
import software.kes.scaletta.internal.scanner.CharacterClass._
import software.kes.scaletta.internal.scanner.ScanError.{EmptyQuotedIdentifier, IdentifierTooLong, UnclosedQuotedIdentifier}
import software.kes.scaletta.internal.scanner.Token.Error
