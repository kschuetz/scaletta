...
final class MultiStack private(private val control: ByteStack,
                               private val objects: ObjectStack,
                               private val booleans: BooleanStack,
                               private val ints: IntStack,
                               private val longs: LongStack,
                               private val shorts: ShortStack,
                               private val bytes: ByteStack,
                               private val chars: CharStack,
                               private val doubles: DoubleStack,
                               private val floats: FloatStack) {
